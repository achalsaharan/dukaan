export function Sidebar() {
    return (
        <div className="flex flex-col divide-y divide-red-100 h-screen md:sticky md:top-16 md:h-auto text-slate-50">
            {/* <Link
            ...
            <div className="flex flex-col">
                <div className=" p-2 rounded flex items-center hover:bg-purple-800">
